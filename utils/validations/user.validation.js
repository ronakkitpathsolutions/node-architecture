...
export const validateChangePassword = (data) => ChangePasswordSchema.safeParse(data);
...
export const validateUpdateProfile = (data) => UpdateProfileSchema.safeParse(data);
