...
const RoleValidationSchema = z.object({
  name: z
    ...
    .refine(
      ...
      VALIDATION_MESSAGES.ROLE.NAME.INVALID_FORMAT
    ),
...
export const validateBulkAssignRole = data =>
  BulkAssignRoleSchema.safeParse(data);
export const validateRolePermission = data =>
  RolePermissionSchema.safeParse(data);
