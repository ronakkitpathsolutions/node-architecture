...
const ResourceEnum = z.enum([
    "user", "role", "permission", "profile",
    "dashboard", "settings", "reports", "logs",
    "files", "uploads", "notifications", "system"
]);
...
export const CreatePermissionSchema = PermissionValidationSchema.refine(
    (data) => {
        ...
        return data.name === expectedName || data.name.includes(`${data.action}_${data.resource}`);
    },
    {
...
export const validateCreatePermission = (data) => CreatePermissionSchema.safeParse(data);
export const validateUpdatePermission = (data) => UpdatePermissionSchema.safeParse(data);
export const validateAssignPermissionToRole = (data) => AssignPermissionToRoleSchema.safeParse(data);
export const validateBulkAssignPermission = (data) => BulkAssignPermissionSchema.safeParse(data);
export const validateCheckPermission = (data) => CheckPermissionSchema.safeParse(data);
export const validateFilterPermission = (data) => FilterPermissionSchema.safeParse(data);
