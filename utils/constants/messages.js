...
export const VALIDATION_MESSAGES = {
    ...
    ROLE: {
        NAME: {
            ...
            INVALID_FORMAT: "Role name can only contain letters, numbers, underscores, and hyphens",
    ...
    PERMISSION: {
        NAME: {
            ...
            INVALID_FORMAT: "Permission name can only contain letters, numbers, underscores, dots, and hyphens",
            PATTERN_MISMATCH: "Permission name should follow the pattern: action_resource",
